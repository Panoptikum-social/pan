defmodule Pan.AlternateFeedControllerTest do
  ...
  describe "when user is logged in and is an admin" do
    ...
    test "updates chosen resource and redirects when data is valid", %{conn: conn} do
      ...
      conn =
        put(conn, alternate_feed_path(conn, :update, alternate_feed), alternate_feed: @valid_attrs)
    ...
    test "does not update chosen resource and renders errors when data is invalid", %{conn: conn} do
      ...
      conn =
        put(conn, alternate_feed_path(conn, :update, alternate_feed),
          alternate_feed: @invalid_attrs
        )
