...
var tour = {
  ...
  steps: [
    { title: "Category Tree",
      content: "You can search for new podcasts using the category buttons in the category tree",
      target: "category_tree",
      placement: "right",
      multipage: true,
      onNext: function() {window.location = "/categories/1"} },
    { title: "Select a language",
      content: "Let's go for a German podcast",
      target: "lang-German",
      placement: "bottom" },
    ...
    { title: "Header Area",
      content: "Lots of metadata is provided in the header area",
      target: "header",
      placement: "bottom" },
    { title: "End",
      content: "This tour has come to an and, but it will be continued soon. <br/>Please come back in a few days!",
      target: "tour",
      placement: "left"}
]}
