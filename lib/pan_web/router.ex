defmodule PanWeb.Router do
  ...
  pipeline :browser do
    ...
    plug(:put_root_layout, html: {PanWeb.LayoutView, :root})
  ...
  pipeline :browser_minimal_root_layout do
    ...
    plug(:fetch_session)
    plug(:fetch_live_flash)
    plug(:put_root_layout, html: {PanWeb.LayoutView, :minimal_root})
    plug(:protect_from_forgery)
    plug(:put_secure_browser_headers)
    plug(PanWeb.Auth, repo: Pan.Repo)
  end
  ...
  scope "/moderator", PanWeb do
    ...
    live(
      "/moderation/:id/podcast/:podcast_id/episodes",
      Live.Moderation.EpisodeGrid,
      :episode_grid,
      as: :moderation_frontend
    )

    live("/moderation/:id/podcast/:podcast_id/feeds", Live.Moderation.FeedGrid, :feed_grid,
      as: :moderation_frontend
    )

    live("/moderation/:id/podcast/:podcast_id", Live.Moderation.EditPodcast, :edit_podcast,
      as: :moderation_frontend
    )

    live("/moderation/:id/episode/:episode_id", Live.Moderation.EditEpisode, :edit_episode,
      as: :moderation_frontend
    )
