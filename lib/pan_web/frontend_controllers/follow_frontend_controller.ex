defmodule PanWeb.FollowFrontendController do
  ...
  def unfollow_all_categories(conn, _, user) do
    Repo.delete_all(from f in Follow, where: f.follower_id == ^user.id
                                             and not is_nil(f.category_id))
