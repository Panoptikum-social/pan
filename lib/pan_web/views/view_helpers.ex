defmodule PanWeb.ViewHelpers do
        ...
        "file-audio-lineawesome" ->
          ...
          <svg xmlns="http://www.w3.org/2000/svg"
            ...
            <path stroke-linecap="round"
                  stroke-linejoin="round"
                  stroke-width="2"
                  d="M 6 3 L 6 29 L 26 29 L 26 3 Z M 8 5 L 24 5 L 24 27 L 8 27 Z M 16 9.71875 L 16 16.1875 C 15.683594 16.074219 15.351563
                     16 15 16 C 13.355469 16 12 17.355469 12 19 C 12 20.644531 13.355469 22 15 22 C 16.644531 22 18 20.644531 18 19
                     L 18 12.28125 L 20.75 12.96875 L 21.25 11.03125 Z M 15 18 C 15.5625 18 16 18.4375 16 19 C 16 19.5625 15.5625
  ...
  def la_nav_icon(name) do
    icon(name, class: "text-coolGray-200 h-6 w-6 inline")
  end
