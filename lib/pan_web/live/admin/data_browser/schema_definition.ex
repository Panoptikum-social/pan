        ...
        <div class="p-4">
          ...
          <div x-show="selectedTab === 4">
            <div x-data="{ selectedAssociation: 0 }" class="-mt-3">
              <ul class="flex flex-wrap border-b border-gray bg-linear-to-r from-gray-lightest via-gray-lighter to-gray-light">
                <li :for={{association, assoc_index} <- Enum.with_index(@model.__schema__(:associations))}
              ...
              <div :for={{details, assoc_index} <- @model.__schema__(:associations) |> Enum.map(&@model.__schema__(:association, &1)) |> Enum.with_index}
                ...
                <table cellspacing="4px" class="border-separate">
                  ...
                  <tr>
                    ...
                    <td class="bg-white">
                      <div :for={default <- details.defaults} class="mx-1 flex space-x-2 justify-start">
                  ...
                  <tr :if={Map.has_key?(details, :join_defaults)}>
                    ...
                    <td class="bg-white">
                      <div :for={default <- details.join_defaults} class="mx-1 flex space-x-2 justify-start">
                        {default |> Atom.to_string}
                      </div>
                    </td>
                  </tr>
                  ...
                  <tr :if={Map.has_key?(details, :join_where)}>
                    ...
                    <td class="bg-white">
                      <div :for={{key, value} <- details.join_where} class="mx-1 flex space-x-2 justify-start">
                        {key |> Atom.to_string}: {value |> Atom.to_string}
                      </div>
                    </td>
                  </tr>
