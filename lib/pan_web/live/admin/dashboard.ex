  ...
  def render(assigns) do
    ...
    <div>
      ...
      >
        ...
        <:cols :let={schema} title="title">
          {schema.title |> Naming.model_in_plural()}
        </:cols>
      </.live_component>

      <div class="-mt-2 mx-2 flex flex-wrap gap-4 border-x border-gray p-2 max-w-4xl">
        <LinkButton.render
      ...
      <div class="mx-2 flex flex-wrap gap-4 items-center border border-gray p-2 max-w-4xl">
        ...
        />
        <LinkButton.render
          title="Migrate Manticore Search Indices"
          to={search_path(Endpoint, :migrate)}
          class="btn-error"
          opts={[data: [confirm: "Are you sure?"]]}
        />
        <LinkButton.render
          title="Delete Orphaned Index Entries"
