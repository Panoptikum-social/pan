...
var tour = {
  ...
  steps: [
    ...
    { title: "Select a category",
      ...
      placement: "right",
      multipage: true,
      onNext: function() {window.location = "/categories/6"} },
    ...
    { title: "Select a podcast",
      ...
      target: "podcast-23963",
      placement: "bottom",
      multipage: true,
      onNext: function() {window.location = "/podcasts/23963"} },
    ...
    { title: "Header Area",
      ...
      target: "metadata",
      placement: "left",
      onPrev: function() {window.location = "/categories/6"} },
    ...
    { title: "Episodes",
      ...
      target: "episode-1536168",
      placement: "right" },

    { title: "Select an Episode",
      content: "... or navigate to the episode page immediately.",
      target: "detail-1536168",
      placement: "right",
      multipage: true,
      onNext: function() {window.location = "/episodes/1536168"} },
    ...
    { title: "Header Area",
      ...
      target: "metadata",
      placement: "right",
      onPrev: function() {window.location = "/podcasts/23963"} },
    ...
    { title: "Podlove Web Player",
      content: "And last, but not least, we have the Podlove Web Player to listen to the episode.<br/>" +
    ...
    { title: "Profile Page",
      ...
      target: "photo",
      placement: "right",
      onPrev: function() {window.location = "/episodes/1536168"} },
    ...
    { title: "The End",
      content: "This tour has come to an end, but there is more than 1.6 million episodes awaiting you.<br/>" +
